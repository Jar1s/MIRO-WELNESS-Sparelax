      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8 sm:p-10 border border-[#e8e6e3] text-center space-y-6">
          ...
          <div className="space-y-3 text-[#2c2c2c] text-base sm:text-lg">
            <p className="font-semibold">Email: <a className="text-[#CD7F32] hover:text-[#A0522D]" href="mailto:wellnessheavensk@gmail.com">wellnessheavensk@gmail.com</a></p>
            <p className="text-[#6b6b6b]">Adresa: Ivanská cesta 15, 821 04 Bratislava</p>
          </div>
