...
const metadataByLocale: Record<Locale, Metadata> = {
  sk: {
    ...
    description:
      'Kontaktujte nás na adrese Ivanská cesta 15, 821 04 Bratislava. Otváracie hodiny: Po-Pi 11:00-22:00, So-Ne 10:00-22:00.',
  },
  en: {
    title: 'Contact - Spa-Relax Bratislava | Contact Information',
    description:
      'Contact us at Ivanská cesta 15, 821 04 Bratislava or by phone +421 952 594 945. Opening hours: Mon-Fri 11:00-22:00, Sat-Sun 10:00-22:00.',
  },
};
...
const copy = {
  sk: {
    ...
    follow: 'Sledujte nás',
    mapTitle: 'Spa-Relax Bratislava - Ivanská cesta, Bratislava',
  },
  en: {
    ...
    <div className="pt-20 sm:pt-24 lg:pt-32 pb-16 sm:pb-20 md:pb-24 lg:pb-32 bg-[#faf9f7] min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="w-24 h-1 bg-[#CD7F32] mx-auto mb-3 sm:mb-4"></div>
          <p className="text-lg sm:text-xl text-[#6b6b6b] mb-2">{t.subtitle}</p>
          <p className="text-base sm:text-lg text-[#CD7F32] italic font-display">{t.quote}</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-10 md:p-12 border border-[#e8e6e3] text-center space-y-3">
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-[#9b9b9b] text-xs sm:text-sm mt-1">GPS: 48.1666686, 17.1729921</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <a
                  ...
                  className="text-[#CD7F32] hover:text-[#A0522D] transition-colors font-medium text-sm sm:text-base break-all"
                >
              ...
              <div className="space-y-2">
                ...
                <a
                  ...
                  className="text-[#CD7F32] hover:text-[#A0522D] transition-colors font-medium text-sm sm:text-base"
                >
                  +421 952 594 945
                </a>
              </div>
        ...
        <div className="max-w-5xl mx-auto mb-8 sm:mb-12">
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-[#e8e6e3]">
            ...
            <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px]">
              <iframe
                src="https://www.google.com/maps?q=48.1666686,17.1729921&output=embed"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
            ...
            <div className="p-6 sm:p-8 md:p-10 pt-4 sm:pt-6">
              <a
                href="https://www.google.com/maps/search/?api=1&query=48.1666686,17.1729921"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center text-[#CD7F32] hover:text-[#A0522D] transition-colors font-medium text-sm sm:text-base min-h-[44px] touch-manipulation"
              >
