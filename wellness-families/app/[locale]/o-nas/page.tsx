...
const metadataByLocale: Record<Locale, Metadata> = {
  sk: {
    ...
    description:
      'Poznajte Spa-Relax Bratislava – súkromný wellness v Bratislave. Súkromné prostredie, individuálny prístup a profesionálny personál.',
  },
  en: {
    title: 'About Us - Spa-Relax Bratislava | Private Wellness Bratislava',
    description:
      'Get to know Spa-Relax Bratislava - private wellness in Bratislava. Private environment, personal approach and professional staff.',
  },
};

const copy = {
  sk: {
    title: 'Poznajte Spa-Relax Bratislava',
    sectionTitle: 'Privátny Wellness',
    p1: 'Vitajte v Spa-Relax Bratislava – súkromnom wellness centre v Bratislave. Ponúkame súkromný wellness pre dvoch alebo partiu priateľov. Nie sme ako ostatné hromadné alebo hotelové wellness.',
  ...
  en: {
    title: 'Get to Know Spa-Relax Bratislava',
    sectionTitle: 'Private Wellness',
    p1: 'Welcome to Spa-Relax Bratislava - a private wellness center in Bratislava. We offer private wellness for couples or groups of friends. We are different from crowded public or hotel spas.',
