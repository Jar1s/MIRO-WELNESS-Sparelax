...
const metadataByLocale: Record<Locale, Metadata> = {
  sk: {
    ...
    description:
      'Ponúkame privátny wellness č.1, privátny wellness č.2, saunu, relaxačnú miestnosť a masáže v Bratislave.',
  },
  en: {
    title: 'Services - Spa-Relax Bratislava | Wellness Bratislava',
    description:
      'We offer private wellness no.1, private wellness no.2, sauna, relaxation room and massages in Bratislava.',
  },
};
  ...
  sk: [
    {
      ...
      features: ['60 min - 50 €', '90 min - 60 €', '120 min - 70 €', '180 min - 120 €'],
    },
    {
    ...
    },
    {
      ...
      features: ['60 min - 40 €', '90 min - 50 €', '120 min - 60 €', '180 min - 120 €'],
    },
    {
      ...
      features: ['60 min - 30 €', '90 min - 40 €', '120 min - 50 €', '180 min - 100 €'],
    },
    {
      title: 'Masáž',
  ...
  en: [
    {
      ...
      description: 'Private wellness space for uninterrupted rest and regeneration.',
      image: '/images/optimized/image.webp',
      features: ['60 min - 50 €', '90 min - 60 €', '120 min - 70 €', '180 min - 120 €'],
    },
    {
      title: 'Private Wellness No.2',
      description: 'Second private wellness area with the same stay duration options.',
      image: '/images/optimized/image-6.webp',
      features: ['60 min - 50 €', '90 min - 60 €', '120 min - 70 €', '180 min - 120 €'],
    },
    {
      title: 'Private Sauna',
      description: 'Private sauna for peaceful rest and recovery.',
      image: '/images/optimized/image-2.webp',
      features: ['60 min - 40 €', '90 min - 50 €', '120 min - 60 €', '180 min - 120 €'],
    },
    {
      title: 'Relax Room',
      description: 'Quiet space for rest after sauna or a demanding day.',
      image: '/images/optimized/image-5.webp',
      features: ['60 min - 30 €', '90 min - 40 €', '120 min - 50 €', '180 min - 100 €'],
    },
    {
      title: 'Massage',
      description: 'Relaxing massage for regeneration and rest.',
      image: '/images/optimized/image-7.webp',
      features: ['50 min - 35 €'],
    },
  ],
