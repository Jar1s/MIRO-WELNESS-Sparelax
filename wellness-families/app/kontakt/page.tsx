    ...
    <div className="pt-20 sm:pt-24 lg:pt-32 pb-16 sm:pb-20 md:pb-24 lg:pb-32 bg-[#faf9f7] min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-[#CD7F32] italic font-display">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 sm:p-10 md:p-12 border border-[#e8e6e3] text-center space-y-3">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-2">
                ...
                <a href="mailto:wellnessheavensk@gmail.com" className="text-[#CD7F32] hover:text-[#A0522D] transition-colors font-medium text-sm sm:text-base break-all">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-[#e8e6e3]">
            ...
            <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px]">
              <iframe
                ...
                title="Spa-Relax Bratislava - Ivanská cesta, Bratislava"
              ></iframe>
            </div>
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-6 sm:p-8 md:p-10 border border-[#e8e6e3]">
          ...
          <div className="flex justify-center space-x-6 sm:space-x-8">
            ...
            <a href="#" className="text-[#6b6b6b] hover:text-[#CD7F32] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center touch-manipulation">
