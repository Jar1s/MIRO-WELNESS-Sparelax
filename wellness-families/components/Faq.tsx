...
const faqsByLocale: Record<Locale, FaqItem[]> = {
  ...
  en: [
    ...
    },
    {
      ...
      answer:
        'You can park in public spaces around the venue (Ivanská cesta 15 / Ružinov). We recommend arriving a few minutes earlier.',
    },
    {
    ...
    {
      question: 'Do you have a sound system? Can we play our own music?',
      answer:
