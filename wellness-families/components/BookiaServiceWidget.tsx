  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-[#e8e6e3] p-8 sm:p-12">
      <div className="text-center">
        <div className="mb-8">
          <div className="w-20 h-20 mx-auto mb-6 bg-[#CD7F32]/10 rounded-full flex items-center justify-center">
        ...
        <div className="space-y-4 mb-8">
          <Link
            href="/kontakt"
            className="inline-block bg-[#CD7F32] text-white px-8 sm:px-10 py-3.5 sm:py-4 rounded-full text-base sm:text-lg font-semibold hover:bg-[#A0522D] transition-all shadow-xl hover:shadow-2xl hover:scale-105 w-full sm:w-auto min-h-[44px] flex items-center justify-center touch-manipulation"
          >
