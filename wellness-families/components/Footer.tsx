        ...
        <div className="flex flex-col items-center gap-10 sm:gap-12">
          <div className="space-y-5 sm:space-y-7 max-w-2xl">
            ...
            <div className="flex justify-center space-x-6">
              <a href="#" className="text-white/70 hover:text-[#CD7F32] transition-colors">
                <span className="sr-only">Facebook</span>
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="https://www.instagram.com/sparelaxbratislava/" className="text-white/70 hover:text-[#CD7F32] transition-colors" target="_blank" rel="noopener noreferrer">
          ...
          <div className="space-y-3 tracking-wide">
            ...
            <div className="text-white/70 text-sm sm:text-base space-y-2">
              ...
              <p>
                <a href="mailto:wellnessheavensk@gmail.com" className="hover:text-[#CD7F32] transition-colors break-all">
